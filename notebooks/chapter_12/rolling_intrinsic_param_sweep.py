...
parser.add_argument("--theta_delta", type=float,
                    default=-0.213183673388138)
parser.add_argument("--initial_delta", type=float,
                    default=0.106417288572204)
parser.add_argument("--kappa_delta", type=float,
                    default=1.17723166341479)
