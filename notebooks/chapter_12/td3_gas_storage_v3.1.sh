#!/bin/bash
#PBS -N td3_gas_storage_v3.1
#PBS -l select=1:ncpus=16:mem=32gb
#PBS -l walltime=96:00:00
#PBS -o td3_gas_storage_v3.1.o
#PBS -e td3_gas_storage_v3.1.e
...
time python -u td3_gas_storage_v3.1.py | tee output_td3_gas_storage_v3.1.log