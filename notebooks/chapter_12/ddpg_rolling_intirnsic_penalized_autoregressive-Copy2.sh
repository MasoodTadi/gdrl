#!/bin/bash
#PBS -N rolling_intrinsic_penalized_autoregressive-Copy2
#PBS -l select=1:ncpus=16:mem=32gb
#PBS -l walltime=96:00:00
#PBS -o rolling_intrinsic_penalized_autoregressive-Copy2.o
#PBS -e rolling_intrinsic_penalized_autoregressive-Copy2.e
...
time python -u rolling_intrinsic_penalized_autoregressive-Copy2.py | tee output_rolling_intrinsic_penalized_autoregressive-Copy2.log