...
time python -u rolling_intrinsic_penalized_autoregressive_modified_AR_n_step.py | tee output_rolling_intrinsic_penalized_autoregressive_modified_AR_n_step.log