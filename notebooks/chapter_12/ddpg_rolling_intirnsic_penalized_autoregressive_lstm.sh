#!/bin/bash
#PBS -N rolling_intrinsic_penalized_autoregressive_lstm
#PBS -l select=1:ncpus=16:mem=32gb
#PBS -l walltime=96:00:00
#PBS -o rolling_intrinsic_penalized_autoregressive_lstm.o
#PBS -e rolling_intrinsic_penalized_autoregressive_lstm.e
...
time python -u rolling_intrinsic_penalized_autoregressive_lstm.py | tee output_rolling_intrinsic_penalized_autoregressive_lstm.log