...
if __name__ == '__main__':
    ...
    # Save the plot to a file
    plt.savefig('ddpg_results_plot_v1.png', dpi=300, bbox_inches='tight')
    ...
    # Save the plot to a file
    plt.savefig('ddpg_timings_plot_v1.png', dpi=300, bbox_inches='tight')
    ...
    np.save(os.path.join(ddpg_root_dir, 'x_v1'), ddpg_x)
    
    np.save(os.path.join(ddpg_root_dir, 'max_r_v1'), ddpg_max_r)
    np.save(os.path.join(ddpg_root_dir, 'min_r_v1'), ddpg_min_r)
    np.save(os.path.join(ddpg_root_dir, 'mean_r_v1'), ddpg_mean_r)
    
    np.save(os.path.join(ddpg_root_dir, 'max_s_v1'), ddpg_max_s)
    np.save(os.path.join(ddpg_root_dir, 'min_s_v1'), ddpg_min_s )
    np.save(os.path.join(ddpg_root_dir, 'mean_s_v1'), ddpg_mean_s)
    
    np.save(os.path.join(ddpg_root_dir, 'max_t_v1'), ddpg_max_t)
    np.save(os.path.join(ddpg_root_dir, 'min_t_v1'), ddpg_min_t)
    np.save(os.path.join(ddpg_root_dir, 'mean_t_v1'), ddpg_mean_t)
    
    np.save(os.path.join(ddpg_root_dir, 'max_sec_v1'), ddpg_max_sec)
    np.save(os.path.join(ddpg_root_dir, 'min_sec_v1'), ddpg_min_sec)
    np.save(os.path.join(ddpg_root_dir, 'mean_sec_v1'), ddpg_mean_sec)
    
    np.save(os.path.join(ddpg_root_dir, 'max_rt_v1'), ddpg_max_rt)
    np.save(os.path.join(ddpg_root_dir, 'min_rt_v1'), ddpg_min_rt)
    np.save(os.path.join(ddpg_root_dir, 'mean_rt_v1'), ddpg_mean_rt)