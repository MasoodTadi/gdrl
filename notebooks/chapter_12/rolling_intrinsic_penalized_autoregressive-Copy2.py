...
for seed in SEEDS:
    ...
    training_strategy_fn = lambda bounds: NormalNoiseStrategy(bounds, exploration_noise_ratio=0.25, final_noise_ratio = 1e-6, max_episode=environment_settings['max_episodes'], 
...
torch.save(best_agent.online_policy_model.state_dict(), "online_policy_model_autoregressive_penalized-Copy2.pth")
...
plt.legend()
plt.grid(True)
plt.savefig("Reinforcement_Learning_Value_Autoregressive_Penalized-Copy2.png")