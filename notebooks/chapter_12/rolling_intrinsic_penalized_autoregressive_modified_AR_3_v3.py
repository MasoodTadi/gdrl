# In v3 the FCQ is updated such that the state and action are concatenated in Input-layer 
...
torch.save(best_agent.online_policy_model.state_dict(), "online_policy_model_autoregressive_penalized_modified_3_v3.pth")
torch.save(best_agent.online_value_model.state_dict(), "online_value_model_autoregressive_penalized_modified_3_v3.pth")
...
plt.savefig("Moving_Average_Reward_Autoregressive_Penalized_modified_3_v3.png")
...
plt.legend()
plt.grid(True)
plt.savefig("Reinforcement_Learning_Value_Autoregressive_Penalized_modified_3_v3.png")