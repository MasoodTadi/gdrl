# v4 is exactly v2 of td3 except that we have Separate state/action encoders + fusion in FCQV
...
torch.save(best_agent.online_policy_model.state_dict(), "online_policy_model_autoregressive_td3_v4.pth")
torch.save(best_agent.online_value_model_1.state_dict(), "online_value_model_1_autoregressive_td3_v4.pth")
torch.save(best_agent.online_value_model_2.state_dict(), "online_value_model_2_autoregressive_td3_v4.pth")
...
plt.savefig("Moving_Average_Reward_Autoregressive_Penalized_td3_v4.png")
...
plt.legend()
plt.grid(True)
plt.savefig("Reinforcement_Learning_Value_Autoregressive_Penalized_td3_v4.png")