#!/bin/bash
#PBS -N rolling_intrinsic_penalized_autoregressive_modified_AR_3_v5
#PBS -l select=1:ncpus=16:mem=64gb
#PBS -l walltime=96:00:00
#PBS -o rolling_intrinsic_penalized_autoregressive_modified_AR_3_v5.o
#PBS -e rolling_intrinsic_penalized_autoregressive_modified_AR_3_v5.e
...
time python -u rolling_intrinsic_penalized_autoregressive_modified_AR_3_v5.py | tee output_rolling_intrinsic_penalized_autoregressive_modified_AR_3_v5.log